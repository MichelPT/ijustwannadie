import 'package:compute_engine_app/model.dart';
import 'package:compute_engine_app/network.dart';
import 'package:compute_engine_app/person_card.dart';
...
class _HomePageState extends State<HomePage> {
  ...
  AppBar get appBar {
    return AppBar(
      title: const Text('Add new person data!'),
      centerTitle: true,
    );
  }
